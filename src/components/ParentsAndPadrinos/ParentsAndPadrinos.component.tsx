    ...
    return (
        ...
        >
            <div className="md:flex md:flex-col md:gap-10 md:mt-10 px-8">
                <h2 className="text-xl font-cormorant-upright font-semibold md:text-2xl mb-10 md:mb-0">{title}</h2>
                <div className="flex flex-col sm:flex-row justify-around gap-10">
                    <div className="flex flex-col gap-4">
                        <h3 className="text-xl font-cormorant-upright font-semibold md:text-2xl">{titleParentsNovia}</h3>
