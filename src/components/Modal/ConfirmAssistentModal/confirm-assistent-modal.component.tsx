            ...
            >
                <div className="py-4 max-w-sm mx-auto bg-white rounded-lg">
                    ...
                    <div className="text-sm w-44 mx-auto sm:w-[43%] mt-4">
                        ...
                        <p className="font-josefin-sans-light">Puedes registrar y confirmar tu asistencia hasta antes del <span className="text-[#193C69] font-josefin-sans-regular">15 de julio</span></p>
                    </div>
                </div>
            </Card>
        </Modal>
